...
import { email1, email2, telepon1, telepon2 } from "../assets";
  ...
  return (
    <div className="w-full py-16 px-4 flex flex-col gap-6  dark:bg-dark sm:px-[96px] ">
      ...
      <div className="w-full flex flex-col justify-center items-center">
        <Kapsul isi="Contact" />
        <p className="text-slate-500 text-center mb-5 sm:text-lg">
          What’s next? Feel free to reach out to me if you're looking for a
          developer, have a query, or simply want to connect:
        </p>
        <div className="flex w-full justify-center gap-3 items-center mb-2">
          <img src={email2} alt="" />
          <p className="text-lg font-semibold dark:text-textDark2 sm:text-2xl">
            alexchandra1998@gmail.com
          </p>
        </div>
        ...
        {/* Contak Lainnya */}
        <div>
          <p className="text-md  text-slate-500 flex flex-col w-full justify-center mb-3 sm:text-lg">
