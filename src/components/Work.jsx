...
const Work = () => {
  return (
    <div className="w-full py-16 px-4 flex flex-col gap-6  dark:bg-dark sm:px-[96px] ">
      ...
      {/* CMN */}
      <div>
        <div className="border-[0.5px] border-slate-100 shadow-md rounded-lg flex flex-col sm:flex-row w-full">
          <div className="w-full p-8 bg-slate-50  flex justify-center sm:w-1/2">
